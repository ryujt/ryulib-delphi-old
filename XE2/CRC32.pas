...
function CRC32String(S:String):DWord;
function CRC32Data(Data:pointer; Size:integer):dword;
...
begin
  ...
  for i := 0 to Size-1 do
    Result := (Result shr 8) xor Table[PByteArray(Data)[i] xor (Result and $000000FF)];
  {$I+}
  Result := Result + DWord(Size);
end;
