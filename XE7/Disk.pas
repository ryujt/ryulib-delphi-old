...
Uses
  DebugTools, Strg,
  ShlObj, WinTypes, ShellAPI, iniFiles, Registry, PsAPI, TlHelp32,
...
Begin
  ...
  Try
    try
      ...
      on E : Exception do Trace('Disk.IniSection - ' + E.Message);
    end;
  Finally
    iniFile.Free;
  End;
...
Begin
  ...
  Try
    try
      ...
      on E : Exception do Trace('Disk.WriteIniStr - ' + E.Message);
    end;
  Finally
    iniFile.Free;
  End;
...
Begin
  ...
  Try
    try
      ...
      on E : Exception do Trace('Disk.WriteIniInt - ' + E.Message);
    end;
  Finally
    iniFile.Free;
  End;
